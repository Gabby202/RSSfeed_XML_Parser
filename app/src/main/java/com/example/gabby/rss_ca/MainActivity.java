...
//                new loadImageFromNetwork(imageView).execute(mFeedLink);
    ...
    private class loadImageFromNetwork extends AsyncTask<String, Void, Drawable> {
        private ImageView _imageView;

        public loadImageFromNetwork(ImageView imageView) {
        ...
        protected Drawable doInBackground(String... uris) {
            ...
            try {
                URL url = new URL(uri);
                Drawable drawable = Drawable.createFromStream((InputStream)url.getContent(), "none");
                return drawable;
            } catch (Exception e) {
                Log.e("loadImageFromNetwork", e.toString());
            }
            return null;
        }
